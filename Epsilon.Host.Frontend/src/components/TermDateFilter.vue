<template>
    ...
    <div class="date-range-menu" ref="dateRangeMenu">
        <button @click="toggleMenu">Date range</button>
        <div class="menu-content" :class="{ 'menu-visible': menuVisible }">
            <div class="date-range-filter">
                <div class="date-input">
                    <label for="startDate">Start date:</label>
                    <input type="date" id="startDate" v-model="startDate" @input="filterItems" />
                </div>
                <div class="date-input">
                    <label for="endDate">End date:</label>
                    <input type="date" id="endDate" v-model="endDate" @input="filterItems" />
                </div>
            </div>
        </div>
    </div>
